...
<center>
	<div style="border: 1px solid #000000; width: 60%; border-radius: 15px; margin-top: 20px; box-shadow: 0px 0px 10px 0px #000000; padding: 15px; background-color: #A1EE9F">
		...
		%>
			...
			<table border="1" border-color="black">
				...
				<tbody>
					...
					<tr style="background-color: LightBlue; color: Black;">
						<form method="get" action="servletInternoCursos">
							<td align="center">
								<%=c.getID()%>
								<input type="hidden" name="IdCursoSeleccionado" value="<%=c.getID()%>">
							</td>
							<td align="center">
								<%=c.getMateria()%>
							</td>
			...
			<form action="servletInternoCursos" method="get" >
				...
				style="border: 2px solid #797777; background-color: #F3E276; box-shadow: 0px 0px 10px 0px #000000; border-radius: 15px; font-weight: 400; font-size: 18px; padding-top: 3px; padding-bottom: 3px; padding-inline: 3px; margin-left: 80%;">
			</form>
	</div>
</center>
