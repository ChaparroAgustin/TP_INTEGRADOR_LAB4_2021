...
%>
	...
	%>
		...
		<br>
		<br>
		<input type="submit" name="btnBaja" value="Eliminar" onClick="return confirm('¿Seguro que desea dar de baja al docente?');" style="border: 2px solid #3C67E2; background-color: #20FFD0; box-shadow: 0px 0px 10px 0px #000000; border-radius: 15px; font-weight: 400; font-size: 18px; padding-top: 3px; padding-bottom: 3px;padding-inline: 3px;">
		<br>
		<%} %>
		<br>
		<br>
