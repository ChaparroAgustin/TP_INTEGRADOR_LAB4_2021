		...
		<table>
			...
			<tr>
				<td align="center">
					...
					<input type="text" name="txtNacimiento" style="background-color: #C1C1C1;">
				</td>
				<td align="center">
					<h5 style="margin-bottom: 2px;">Dirección:</h5>
					<input type="text" name="txtDireccion" style="background-color: #C1C1C1;">
				</td>
			</tr>
			<tr>
				<td align="center">
					<h5 style="margin-bottom: 2px;">Nacionalidad:</h5>
					<select name="selectNacionalidad" style="width: 144px; background-color: #C1C1C1;">		
						<%-- Inyectar código --%>		
					</select>
				</td>
				<td align="center">
					<h5 style="margin-bottom: 2px;">Provincia:</h5>
					<select name="selectProvincia" style="width: 144px; background-color: #C1C1C1;">	
						<%-- Inyectar código --%>					
					</select>
				</td>
			</tr>
			<tr>
				<td align="center">
					...
					<input type="text" name="txtEmail" style="background-color: #C1C1C1;">
				</td>
				<td align="center">
					<h5 style="margin-bottom: 2px;">Teléfono:</h5>
					<input type="text" name="txtTelefono" style="background-color: #C1C1C1;">
				</td>
			</tr>
		</table>	
		<br>
		<br>
		<input type="submit" name="btnAlta" value="Modificar" style="border: 2px solid #3C67E2; background-color: #20FFD0; box-shadow: 0px 0px 10px 0px #000000; border-radius: 15px; font-weight: 400; font-size: 18px; padding-top: 3px; padding-bottom: 3px;padding-inline: 3px;">
		<br><br><br>
